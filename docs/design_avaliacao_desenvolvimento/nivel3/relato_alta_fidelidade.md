...
<iframe width="560" height="315" src="https://www.youtube.com/embed/kRiV_GWmz_M" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
...
criado ao início do projeto. A avaliação foi realizada mediante a participação de 2 entrevistados: Arthur Sousa e Danilo Naves.
...
|3 |  Qual parte da interação o deixa insatisfeito? | Não conseguir voltar para a página anterior|
|4  | O usuário entende os elementos e para que eles servem? | Sim | 
|5  |O usuário sabe o que fazer em cada tarefa? | Sim | Ao localizar as juntas próximas da região do Guará, ele tetou selecionar umas das opções, que eram apenas para consulta
|6  |Quais problemas de IHC dificultam o alcance dos objetivos do usuário? | Uma das heurísticas de Nielsen não foi atendida | Não tem a opção de voltar nas páginas, isso chamou a atenção do entrevistado
|7 |Quais os principais aspectos que atralham o usuário a alcançar seus objetivos? | Não houve |
